    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40">
      <div className="bg-white rounded-2xl w-full max-w-md shadow-xl overflow-hidden relative animate-in fade-in zoom-in-95 duration-200">
        ...
        <div className="flex items-center justify-between p-6 pb-4">
          <h2 className="text-xl font-bold text-gray-900">I-edit ang Impormasyon</h2>
          <button 
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="p-6 pt-0 space-y-5">
          ...
          <div className="space-y-1.5">
            <label className="text-sm font-medium text-gray-600">Buong Pangalan</label>
            <input
              type="text"
              required
          ...
          <div className="space-y-1.5">
            <label className="text-sm font-medium text-gray-600">Address sa Barangay</label>
            <textarea
              required
          ...
          <div className="flex items-center gap-3 pt-2">
            ...
            >
              {isSubmitting ? <Loader2 className="w-5 h-5 animate-spin" /> : "I-save"}
            </Button>
          </div>
